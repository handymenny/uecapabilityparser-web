import{a7 as l,a6 as v}from"./q-POVI9Nn8.js";import{l as i,o as _,j as p,x as u,e as c,y as n,_ as s,a as m,b as d}from"./q-kBRCEvCZ.js";const x=a=>{const[e,o]=i();e.positionX.value&&(e.value.value=l(a.pageX-e.positionX.value,e.min.value,e.max.value)),o.value=!0},f=a=>{const[e,o]=i();e.positionX.value&&o.value&&(e.value.value=l(a.pageX-e.positionX.value,e.min.value,e.max.value))},g=a=>{const[e,o]=i();e.positionX.value&&o.value&&(e.value.value=l(a.pageX-e.positionX.value,e.min.value,e.max.value)),o.value=!1},w=a=>{const e=_(!1),o=p(v),r=n(()=>s(()=>Promise.resolve().then(()=>t),void 0),"s_D8WvLnKHNUw",[o,e]);return u("mousemove",n(()=>s(()=>Promise.resolve().then(()=>t),void 0),"s_kd2cGCnxV3Y",[o,e])),u("mouseup",n(()=>s(()=>Promise.resolve().then(()=>t),void 0),"s_mV7WaK4570w",[o,e])),c("div",{style:`
        width: 20px;
        height: 20px;
        border-radius: 20px;
